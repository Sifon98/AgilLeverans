...
function SideMenu({ chooseFilter, chooseCategory, products, removeFilter, chooseColor, chooseSize, size, color, backArrow, home, backPath }) {
    ...
    return (
        <>
            <div className="menu-toggle">
                {
                    backArrow ? home ? <div onClick={() => setNav({path: backPath, direction: 0})} className="back-arrow"><i className="fas fa-home"></i></div> :
                     <div onClick={() => setNav({path: backPath, direction: 0})} className="back-arrow"><i className="fas fa-arrow-left"></i></div> : (
                        <>
