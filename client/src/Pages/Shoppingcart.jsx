                ...
                <div className="boxContainer">
                    <div className="itemContainer">
                        ...
                        <div className="paymentMethods">
                            <p className="paymentText">we accept.</p>
                            <svg width="131" height="21" viewBox="0 0 131 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5.59717 19.7217C9.55048 21.6125 14.4297 20.6768 17.3772 17.1647C20.8709 13.0018 20.3283 6.79597 16.1652 3.30347L13.3977 6.6011C16.65 9.32958 17.074 14.178 14.3446 17.4302C12.168 20.0231 8.58465 20.889 5.59717 19.7216" fill="url(#paint0_linear)"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M5.59717 19.7217C9.55048 21.6125 14.4297 20.6768 17.3772 17.1647C17.7323 16.7419 18.0514 16.2901 18.3313 15.8141C18.7968 12.9215 17.7731 9.86405 15.3652 7.84397C14.7686 7.34281 14.1069 6.92487 13.398 6.60156C16.6501 9.33004 17.0737 14.1781 14.3445 17.4301C12.1681 20.0233 8.58487 20.8891 5.59717 19.7217Z" fill="url(#paint1_linear)"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.083 1.95806C10.1296 0.0674745 5.25057 1.0032 2.30294 4.51529C-1.1908 8.67813 -0.648169 14.884 3.5149 18.3765L6.28255 15.0789C3.03013 12.3504 2.60615 7.50198 5.33564 4.24979C7.51197 1.65652 11.0952 0.790756 14.0828 1.95817" fill="url(#paint2_linear)"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.0829 1.95806C10.1296 0.0674745 5.25051 1.0032 2.30287 4.51529C1.94776 4.93812 1.62862 5.3899 1.3488 5.86592C0.883287 8.75849 1.90698 11.8158 4.3149 13.836C4.91144 14.3372 5.57318 14.7551 6.28204 15.0784C3.03007 12.3499 2.60631 7.50187 5.33557 4.24979C7.51191 1.65652 11.0952 0.790756 14.0828 1.95817" fill="url(#paint3_linear)"/>
                                <defs>
